...
export class TerminalProcess extends EventEmitter<TerminalProcessEvents> {
    ...
    if (terminal.shellIntegration?.executeCommand) {
      ...
      for await (let data of stream) {
        ...
        if (isFirstChunk) {
          ...
          // biome-ignore lint/suspicious/noControlCharactersInRegex: TODO refactor to avoid control characters in regex
  ...
  private emitIfEol(chunk: string) {
    ...
    // biome-ignore lint/suspicious/noAssignInExpressions: TODO refactor to avoid assignment in while loop condition
