...
export const ChatRowContent = ({ message, isExpanded, onToggleExpand, lastModifiedMessage, isLast }: ChatRowContentProps) => {
		...
		switch (type) {
			...
			case "mistake_limit_reached":
				return [
					...
					<span style={{ color: errorColor, fontWeight: "bold" }}>Clama is having trouble...</span>,
				]
			...
			case "followup":
				return [
					...
					<span style={{ color: normalColor, fontWeight: "bold" }}>Clama has a question:</span>,
				]
			default:
				return [null, null]
		}
	...
	if (tool) {
		...
		switch (tool.tool) {
					...
					<>
						<div style={headerStyle}>
							...
							<span style={{ fontWeight: "bold" }}>
								{message.type === "ask" ? "Clama wants to edit this file:" : "Clama is editing this file:"}
							</span>
						</div>
						<CodeAccordian
				...
				return (
					<>
						<div style={headerStyle}>
							{toolIcon("new-file")}
							<span style={{ fontWeight: "bold" }}>
								{message.type === "ask" ? "Clama wants to create a new file:" : "Clama is creating a new file:"}
							</span>
						</div>
						<CodeAccordian
							isLoading={message.partial}
				...
				return (
					<>
						<div style={headerStyle}>
							{toolIcon("file-code")}
							<span style={{ fontWeight: "bold" }}>
								{message.type === "ask" ? "Clama wants to read this file:" : "Clama read this file:"}
							</span>
						</div>
						{/* <CodeAccordian
							code={tool.content!}
				...
				return (
					<>
						<div style={headerStyle}>
							...
							<span style={{ fontWeight: "bold" }}>
								{message.type === "ask"
									? "Clama wants to view the top level files in this directory:"
									: "Clama viewed the top level files in this directory:"}
							</span>
						</div>
						<CodeAccordian
							code={tool.content!}
				...
				return (
					<>
						<div style={headerStyle}>
							...
							<span style={{ fontWeight: "bold" }}>
								{message.type === "ask"
									? "Clama wants to recursively view all files in this directory:"
									: "Clama recursively viewed all files in this directory:"}
							</span>
						</div>
						<CodeAccordian
							code={tool.content!}
				...
				return (
					<>
						<div style={headerStyle}>
							...
							<span style={{ fontWeight: "bold" }}>
								{message.type === "ask"
									? "Clama wants to view source code definition names used in this directory:"
									: "Clama viewed source code definition names used in this directory:"}
							</span>
						</div>
						<CodeAccordian
							code={tool.content!}
					...
					<>
						<div style={headerStyle}>
							...
							<span style={{ fontWeight: "bold" }}>
								{message.type === "ask" ? (
									<>
										Clama wants to search this directory for <code>{tool.regex}</code>:
									</>
								) : (
									<>
										Clama searched this directory for <code>{tool.regex}</code>:
									</>
								)}
							</span>
						</div>
			...
			// 				<span style={{ fontWeight: "bold" }}>
			// 					{message.type === "ask" ? (
			// 						<>Clama wants to inspect this website:</>
			// 					) : (
			// 						<>Clama is inspecting this website:</>
			// 					)}
			// 				</span>
			// 			</div>
			// 			<div
									...
									<p
										...
										{apiRequestFailedMessage?.toLowerCase().includes("powershell") && (
											<>
												...
												<a
													href="https://github.com/crantotech/clama/wiki/TroubleShooting-%E2%80%90-%22PowerShell-is-not-recognized-as-an-internal-or-external-command%22"
													style={{
														color: "inherit",
					...
					return (
						<>
							<div
								...
								<div>
									Clama won't be able to view the command's output. Please update VSCode (
									<code>CMD/CTRL + Shift + P</code> → "Update") and make sure you're using a supported shell:
									zsh, bash, fish, or PowerShell (<code>CMD/CTRL + Shift + P</code> → "Terminal: Select Default
									Profile").{" "}
									<a
										href="https://github.com/crantotech/clama/wiki/Troubleshooting-%E2%80%90-Shell-Integration-Unavailable"
										style={{
											color: "inherit",
											textDecoration: "underline",
										}}>
